...
aboutme: I am a \textcolor{cyan}{\textbf{geospatial data scientist}} leading the \textcolor{cyan}{\textbf{hydrofabric development for NOAA's Next Generation National Water Model}} along with collaborative federal efforts to define a national suite of hydroinformatic data products. I seek to bridge \textcolor{cyan}{\textbf{data-intensive computational geography}} with \textcolor{cyan}{\textbf{water resources research}} to design new data products and develop open-source software to ease community access to big geospatial data.
headcolor: 414141
csl: apa-cv.csl
output: 
  vitae::awesomecv:
...
cites = get_publications(gs_id, sortby = "year") %>% 
   filter(!grepl("AGU|EGU|Fall Meeting|Preprint|SUMMER INSTITUTE", journal)) %>%
   filter(journal != "")
...
tribble(
  ...
  "Water Resources Data Scientist", "", "", "Aug 2020 - Sep 2023", 
    list("Lead spatial data development for the NOAA NextGen Water Resource Modeling Framework",
  ...
  "Hydrofabric Technical Director", "NOAA Office of Water Prediction", "Remote", "Sep 2022 - Present", 
    list("Develop, document, and publish foundational geospatial products to support version 4 of the National Water Model",
         ...
         "Lead a team developing novel machine learning, geospatial, and cloud based solutions of more open and skilled science"),
  
  "Lead Hydrofabric Developer", "", "", "Aug 2020 - Sep 2022", 
   character(),
  
  "Lead Data Scientist (Independent Contractor)", "Urban Flooding Open Knowledge Network", "Remote", "Nov 2019 - Apr 2023", 
    list("Co-authored successful proposals to NSF and acted as an advocate for the team in the initial C-ACCEL program",
  ...
  "Lecturer", "Geography Department", "UC Santa Barbara", "Summer 2020, 2021", 
    list("Designed and taught the first programming based GIS course for UC Santa Barbara in R."),
  
  "Research Coordinator", "NOAA Office of Water Prediction", "Tuscaloosa, AL", "2016", 
...
}{I have personally solicited \textbf{\`r personal`} for research and development and been a core member of teams who have solicited \textbf{\`r team`}.}
...
tribble(
  ...
  "\\href{https://github.com/NOAA-OWP/hydrofabricI}{NOAA-OWP/hydrofabric}", "Lead Developer", "Generating data products for continental scale hydrology",
   "\\href{https://github.com/mikejohnson51/FHGestimation}{FHGestimation}", "Lead Developer", "Estimating robust, mass conserving AHG relationships with cross section hydrualics and geometry",
) %>%
