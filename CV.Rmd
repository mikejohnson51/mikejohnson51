...
cites = get_publications(gs_id) %>% 
   filter(!grepl("AGU|EGU|Meeting|meeting|Preprint|SUMMER INSTITUTE", journal)) %>%
   filter(journal != "")
...
tribble(
  ...
  "Hydrofabric Technical Director", "NOAA Office of Water Prediction", "Remote", "Sep 2022 - Present", 
    list("Develop foundational geospatial products to support the Next Generation Water Modeling Framework",
         "Collaborate with the USGS to build a suite of federal software and data products to support the NOAA and USGS Water Mission Areas", 
         "Work with the CIROH member univierities to support research to operation hydrology",
...
tribble(
  ...
  "\\href{https://github.com/NOAA-OWP/hydrofabricI}{NOAA-OWP/hydrofabric}", "Lead Developer", "Generating data products for continental scale hydrology",
   "\\href{https://github.com/mikejohnson51/AHGestimation}{FHGestimation}", "Lead Developer", "Estimating robust, mass conserving AHG relationships with cross section hydrualics and geometry",
) %>%
