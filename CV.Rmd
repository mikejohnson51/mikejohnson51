...
aboutme: I am a \textcolor{cyan}{\textbf{geospatial data scientist}} leading the \textcolor{cyan}{\textbf{hydrofabric development for NOAA's Next Generation National Water Model}} along with collaborative federal efforts (USGS/NOAA) to define a national suite of hydroinformatic\'s products. I seek to bridge \textcolor{cyan}{\textbf{data-intensive computational geography}} with \textcolor{cyan}{\textbf{water resources research}} to design open-source software and data solutions to ease community access to big geospatial data. I still am actively publishing research and am eager to facilitate and grow research collaborations.
