...
make_software = function(software, type = "Author On"){
  ...
  lapply(1:nrow(d), function(x){
    paste0('<div class="row featurette">
      ...
      <div class="col-md-5">
        <img class="featurette-image img-responsive center-block shadow-right" src="', d$pic[x], '" style="width:250px;height:250px;" data-src="holder.js/500x500/auto" alt="Generic placeholder image"></img>
      </div>
     </div>
