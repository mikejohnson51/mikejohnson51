...
authors  = lapply(paste("<strong>", affiliations$Name, "</strong><br>", gsub(";", "<br>", affiliations$people)), 
                  htmltools::HTML)
...
software <- software %>% 
  filter(!is.na(text))  %>% 
  mutate(pic = replace(pic, is.na(pic), "docs/resources/images/software/R_logo.png"))
