...
open-source software to design new data products and ease community
access to big geospatial data.}
...
\end{cvitems}}
    ...
    \cventry{Lead Data Scientist}{Urban Flooding Open Knowledge Network}{Independent Contractor}{Sep 2019 - Apr 2023}{\begin{cvitems}
...
\textcolor{cyan}{I have designed a upper division spatial data science course as a UCSB Lecturer, was a teaching assistant for over 15 courses (700+ students), and have lead community workshops for national organizations.}
...
\newline \newline
\textcolor{cyan}{\href{https://github.com/mikejohnson51}{\faicon{github} Github: \faicon{user} 178 followers; \faicon{star} 526 stars}}
...
\textcolor{cyan}{Included are recent invited presentations at conferences, federal agency meetings, and developer conferences.}
