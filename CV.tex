...
\position{Data Scientist \textbar{} Geographer \textbar{} Water
Resources}
...
\quote{I am a \textcolor{cyan}{\textbf{water resource data scientist}}
leading the
...
\textcolor{cyan}{\textbf{water resources research}} and develop
open-source software to ease community access to big data and design new
data products.}
...
\begin{cventries}
    \cventry{Data Scientist}{Lynker}{Fort Collins, Colorado}{August 2020 - Present}{\begin{cvitems}
\item Lead the spatial data development for the NOAA NextGen Water Resource Modeling Framework
...
\item Develop the foundational geospatial data to support verson 4 of the National Water Model
...
\item Lead a team developing novel Machine learning, geospaial, and cloud based solutions of more open and skilled science
\end{cvitems}}
    \cventry{Lead Data Scientist}{Urban Flooding Open Knowledge Network}{Remote}{Sep 2019 - Apr 2023}{\begin{cvitems}
\item Co-authored two successful proposals to NSF and acted as an advocate for the team in the initial C-ACCEL program
...
\end{cvitems}}
    \cventry{Lecturer}{Geography Department}{UC Santa Barbara}{2021}{\begin{cvitems}
\item Designed and taught the first programming based GIS course for UCSB in R.
\end{cvitems}}
    \cventry{Course Coordinator}{NOAA Office of Water Prediction}{Tuscaloosa, AL}{2016}{\begin{cvitems}
\item Lead students towards the successful execution of projects related to the National Water Model
Research Fellow
...
\item \textbf{Institute for Environmental Studies}. Vrije Universiteit, Amsterdam: June - July 2019; January - March 2018
...
\begin{cventries}
    \cventry{PhD in Geography}{University of California, Santa Barbara}{Santa Barbara, CA}{2021}{\begin{cvitems}
...
\end{cvitems}}
    \cventry{BS in Anthropology \& Geography, Cum Laude}{California Polytechnic State University}{San Luis Obispo, CA}{2010 - 2015}{\begin{cvitems}
\item Recipient of the Outstanding Senior Award
...
\textcolor{cyan}{ \href{https://tinyurl.com/mike-google-scholar}{\faicon{google} Google Scholar: 375 citations; \faicon{user} 20 collaborators; \faicon{file} 22 papers} \newline
...
Fang, S., \textbf{Johnson, J.}, Yeghiazarian, L., \& Sankarasubramanian,
A. (2023). Improved national-scale flood prediction for gauged and
ungauged basins using a spatio-temporal hierarchical model.
\emph{Authorea Preprints}.
...
\textbf{Johnson, J.}, Coll, J., Clarke, K., Afshari, S., Saksena, S., \&
Yeghiazarian, L. (2022). Determining feature based hydraulic geometry
and rating curves using a physically based, computationally efficient
framework. \emph{Preprints}.
...
Coll, J., \textbf{Johnson, J.}, \& Ruess, P. (2016). Radar measurement
and flow modeling: methods. \emph{NATIONAL WATER CENTER INNOVATORS
PROGRAM SUMMER INSTITUTE REPORT}, \emph{2016 4, 7}.

\leavevmode\vadjust pre{\hypertarget{ref-14}{}}%
\textbf{Johnson, J.}, Ruess, P., \& Coll, J. (2016). OPERA--operational
platform for emergency response and awareness: Reimagining disaster
alerts. \emph{NATIONAL WATER CENTER INNOVATORS PROGRAM SUMMER INSTITUTE
REPORT}, \emph{2016 4, 97}.
...
\hypertarget{university-teaching}{%
\subsection{University Teaching}\label{university-teaching}}
...
\hypertarget{award-nominations}{%
\subsection{Award Nominations}\label{award-nominations}}
...
\textcolor{cyan}{\href{https://github.com/mikejohnson51}{\faicon{github} Github: \faicon{user} 178 followers; \faicon{star} 525 stars}}
...
\hypertarget{select-invited-workshops-and-presentations}{%
\section{Select Invited Workshops and
Presentations}\label{select-invited-workshops-and-presentations}}
...
\item Breifed USGS and NOAA Leadership at Quartly Meeting. 
...
\item Design and Lead 2 workshops exposing over 100 new developers to the avaialbe tools, data models, and dataset developed.
\end{cvitems}}
